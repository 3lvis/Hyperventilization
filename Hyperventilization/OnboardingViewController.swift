...
class OnboardingViewController: UIViewController {
    lazy var titleLabel: UILabel = {
        ...
        label.text = "Hyperventilization"
        label.font = UIFont(name: "Montez-Regular", size: 51)
    ...
    lazy var moreInfoLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Get out of a boring meeting or just enjoy the sensation of fainting"
        label.font = UIFont(name: "Oswald-Regular", size: 30)
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            letsGoButton.heightAnchor.constraint(equalToConstant: 140),
            letsGoButton.widthAnchor.constraint(equalToConstant: 140),
